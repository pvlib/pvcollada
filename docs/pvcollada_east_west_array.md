...
An east-west PV array typically mounts rows of modules back-to-back to form a peak, with the two sides at the same tilt:

![East-west array](east-west-pv.png)
Image credit: GSES (2026)
